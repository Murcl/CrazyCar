classdef NeuralNet2_par < handle
    ...
    methods
        function this = NeuralNet2_par(layerSizes)
            ...
            for ii = 1 : numIter
                ...
                for jj = 1 : L
                    ...
                    if jj == L
                        ...
                        xNeuron_tmp{jj} = fcnOut(sNeuron{jj});
                    else
                        xNeuron{jj+1} = [fcn(sNeuron{jj}) ones(B, 1)];
                        xNeuron_tmp{jj} = [fcn(sNeuron{jj}) ones(B, 1)];
                    end
